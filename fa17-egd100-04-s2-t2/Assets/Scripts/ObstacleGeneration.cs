...
public class ObstacleGeneration : MonoBehaviour {
	...
	public EndlessRoadGeneration roadGenerator;
	...
	private void findObstacle(Vector2 chunkCoord)
	{
		...
		foreach (Obstacle o in obstacles) {
			if(ArrayUtility.Contains(o.chunkTypes, chunkType) && ArrayUtility.Contains(o.stages, eventTracker.stage)){
